      ...
      <PageCard>
        ...
        <template #card-content>
          ...
          <DataTable v-model:filters="filters" :value="products" paginator :rows="8"
            ...
            :globalFilterFields="['sku','key', 'name', 'size', 'category']" contextMenu
            v-model:contextMenuSelection="selectedProduct" @rowContextmenu="onRowContextMenu" removableSort>
            ...
            <Column field="category" header="Category" class="w-[10%]" :sortable="true">
              <template #body="slotProps">
                <div class="flex gap-2" v-if="slotProps.data.category && slotProps.data.category.length > 0">
                  <Chip
