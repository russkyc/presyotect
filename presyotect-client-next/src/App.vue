...
<template>
  ...
  <main class="flex overflow-clip" :class="{'grow': pageType === DashboardGroupType.Auth,'h-[calc(100vh-63.2px)]': pageType === DashboardGroupType.Dashboard && !mdAndSmaller,'h-[calc(100vh-112.5px)]': pageType === DashboardGroupType.Dashboard && mdAndSmaller}">
